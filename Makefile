...
##########################LDFLAGS += -Wl,--trace  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc  # disabled for zig-cc
